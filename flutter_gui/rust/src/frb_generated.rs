...
fn wire_parse_midi_to_mml_impl(
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
            ...
            transform_result_sse((move || {
                Result::<_, ()>::Ok(
                    flutter_rust_bridge::for_generated::rust_auto_opaque_encode::<_, MoiArc<_>>(
                        crate::api::simple::parse_midi_to_mml(api_bytes),
                    ),
                )
            })())
        },
...
flutter_rust_bridge::frb_generated_moi_arc_impl_value!(
    flutter_rust_bridge::for_generated::rust_async::RwLock<crate::api::mirror::Song>
);
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    match func_id {
        1 => wire_parse_midi_to_mml_impl(ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
